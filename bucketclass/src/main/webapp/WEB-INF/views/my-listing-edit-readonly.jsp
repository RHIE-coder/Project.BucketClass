...
<body>
	...
	if(userRole === "ROLE_CUSTOMER"){
        ...
        ================================================== -->
											...
											<table id="pricing-list-container">
												<tr class="pricing-list-item pattern">
													<td>
														...
														</div> <!-- <div class="fm-close"><a class="delete" href="#"><i class="fa fa-remove"></i></a></div> -->
									...
									<div class="row with-forms">
										...
										<div class="col-md-12">
											...
											<div>
												...
												<h5>
													<label for="entry_jibeon_address">주소</label><input
			...
			<!-- Content / End -->
			<a href="/provider/active-listing" class="button save">돌아가기<i
